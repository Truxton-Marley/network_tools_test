...
set interfaces ge-0/0/0 unit 234 family inet address 192.168.32.67/24
...
for ip in ips:
    ...
    search_command = "show configuration | display set | match \"" + (".").join(octets[:-1]) + f".[{subnet}-{broadcast}]\""
